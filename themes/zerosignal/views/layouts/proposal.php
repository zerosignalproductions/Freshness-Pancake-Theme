...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<div id="buttonBar" data-status="<?php echo $proposal['status'];?>" >
        <div class="buttonContainer">
            ...
            <?php echo anchor(Settings::get('kitchen_route').'/'.$proposal['client']['unique_id'], 'Go to Dashboard &rarr;'); ?>            
            ...
            <?php if (is_admin()): ?>
                <?php echo anchor('admin/proposals', 'Back to Admin &rarr;'); ?>
...
<?php endif; ?>
        ...
        <div id="wrapper">
            ...
            <a name="cover-page" class="jumptarget"></a>
